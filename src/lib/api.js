// The base URL for my backend server.
// VITE_API_URL comes from the .env file. If it is not set, we fall back to
// localhost. On Vercel, .env.production sets it to an empty string so requests
// go to the same origin (relative /api/... paths) — ?? keeps "" intact.
